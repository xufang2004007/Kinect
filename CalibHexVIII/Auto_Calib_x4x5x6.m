...
Plane_Para = load('Plane_Para1.txt');
...
for i =1:1:60
    T_RWS(i,:,:) = exp_TransM(pos_list(i,1),pos_list(i,2),pos_list(i,3),pos_list(i,4),pos_list(i,5)+0.85+0.035,pos_list(i,6))';
end

plane0 = Plane_Para(1,:);

for i=1:1:60
plane(i,:) = Plane_Para(i+1,:);
end
